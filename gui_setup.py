...
def create_gui():
    ...
    start_button = tk.Button(root, text="Start Camera", command=start_recognition_thread, width=20, height=2)
    start_button.pack(pady=10)

    info = tk.Label(root, text='Press "q" to quit camera view.', font=("Arial", 9))
    info.pack(pady=5)
